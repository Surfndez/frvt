...
OpenVinoInference::Infer(const cv::Mat& image)
{
    ...
    std::cout << "OpenVinoInference::Infer 0. "; t.Test();
    ...
    std::cout << "OpenVinoInference::Infer 1. "; t.Test();

    // --------------------------- 7. Do inference --------------------------------------------------------
    mInferRequest->Infer();
    // -----------------------------------------------------------------------------------------------------

    std::cout << "OpenVinoInference::Infer 2. "; t.Test();

    // --------------------------- 8. Process output ------------------------------------------------------
    Blob::Ptr output = mInferRequest->GetBlob(mOutputName);
    // -----------------------------------------------------------------------------------------------------
    
    std::cout << "OpenVinoInference::Infer 3. "; t.Test();
